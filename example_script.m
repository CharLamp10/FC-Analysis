...
init_path = pwd;
choice_struct.path_data = [init_path, '\example_signal\AbleC EO 01.EDF']; %Enter a valid path
choice_struct.path_eeglab = 'C:\Users\xaral\Desktop\Thesis\final_github\EEGlab\eeglab2021.0'; %Enter a valid path
...
choice_struct.path_fieldtrip = 'C:\Users\xaral\Desktop\Thesis\final_github\fieldtrip';%Enter a valid path
choice_struct.high_pass = 1; choice_struct.low_pass = 100; choice_struct.rereference = "Median";
